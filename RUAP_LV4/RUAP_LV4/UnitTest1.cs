...
namespace SeleniumTests
{
    ...
    public class Prijava
    {
        ...
        public void ThePrijavaTest()
        {
            ...
            driver.FindElement(By.Id("input-email")).SendKeys("ivan.kaucic01@gmail.com");
            driver.FindElement(By.Id("input-password")).Click();
            driver.FindElement(By.Id("input-password")).Clear();
            driver.FindElement(By.Id("input-password")).SendKeys("Dz9feen9");
        ...
        public void TheShoppingCartTest()
        {
            ...
            driver.FindElement(By.LinkText("Show All Desktops")).Click();
            driver.FindElement(By.XPath("//div[@id='content']/div[4]/div[5]/div/div[2]/div[2]/button/span")).Click();
            driver.FindElement(By.XPath("//div[@id='content']/div[4]/div[6]/div/div[2]/div[2]/button/span")).Click();
